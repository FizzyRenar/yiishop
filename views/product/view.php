                ...
                <div class="product-details">
                    <div class="col-sm-5">
                        <div class="view-product">
                            <?=Html::img("@web/images/products/{$product->img}", ['alt' => $product->name, 'title' => $product->name]);?>
                            <h3>ZOOM</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information">
                            ...
                            <?elseif($product->sale == 1):?>
                                <?=Html::img("@web/images/home/sale.png", ['alt' => 'sale', 'class' => 'salearrival'])?>
                            <? endif;?>
                            <h2><?=$product->name?></h2>
                            <span>
